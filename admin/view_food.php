        ...
        <div class="page-header">
          <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
              <h1 class="page-header-title">Manage Food <span class="badge badge-soft-dark ml-2">72,031</span></h1>
            ...
            <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="table-column-pl-0" style="width: 50px">
                    <a class="media align-items-center" href="detail_food.php?id=<?php echo $row['food_id']?>">
                      <img class="avatar avatar-lg mr-3" src="cover/<?php echo $row['cover'] ?>" alt="Image Description">
                      <div class="media-body">
                        <h5 class="text-hover-primary mb-0"><?= $food_name ?></h5>
                      </div>
                    </a>
                  </td>
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <a class="btn btn-sm btn-white" href="edit_food.php?id=<?php echo $row['food_id']?>">
                      ...
                      <div class="hs-unfold btn-group">
                        ...
                        <div id="productsEditDropdown1" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right mt-1">
                           ...
                           <button class='delete dropdown-item' id='del_<?= $id ?>' data-id='<?= $id ?>'><i class="fal fa-trash dropdown-item-icon"></i> Delete</button>

                          <a class="dropdown-item" href="#">
                            <i class="tio-archive dropdown-item-icon"></i> Active
                          </a>
                           <a class="dropdown-item" href="#">
                            <i class="tio-archive dropdown-item-icon"></i> Not Active
                          </a>
                    ...
                    <a href="discount.php?id=<?php echo $row['food_id']; ?>" class="btn btn-primary">Discount</a>
                  </td>
                <td></td>
                </tr>
